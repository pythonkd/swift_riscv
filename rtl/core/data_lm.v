 ...
 * @LastEditTime: 2026-08-27 22:00:36
...
module d_lm(
   ...
   always @(posedge clk)
      if (!data_err & mem_we) begin
         case(addr_offset)
            2'b00: begin
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][7:0]   <= mem_strb[0] ? mem_wr_data[7:0]    : byte0;
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][15:8]  <= mem_strb[1] ? mem_wr_data[15:8]   : byte1;
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][23:16] <= mem_strb[2] ? mem_wr_data[23:16]  : byte2;
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][31:24] <= mem_strb[3] ? mem_wr_data[31:24]  : byte3;
            end
            2'b01: begin
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][15:8]   <= mem_strb[0] ? mem_wr_data[7:0]   : byte1;
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][23:16]  <= mem_strb[1] ? mem_wr_data[15:8]  : byte2;
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][31:24]  <= mem_strb[2] ? mem_wr_data[23:16] : byte3;
            end
            2'b10: begin // access byte2, shift left 2 bytes
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][23:16]  <= mem_strb[0] ? mem_wr_data[7:0]  : byte2;
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][31:24] <= mem_strb[1] ? mem_wr_data[15:8] : byte3;
            end
            2'b11: begin
               local_mem[mem_addr[`DATA_MEM_WIDTH+1:2]][31:24] <= mem_strb[0] ? mem_wr_data[7:0] : byte3;
            end
         endcase
      end
